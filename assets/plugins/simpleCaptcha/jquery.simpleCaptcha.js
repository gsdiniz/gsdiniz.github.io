...
;(function($) {
  ...
  $.extend($.jk.SimpleCaptcha.prototype, {
    ...
    introText: "<p>Para evitar spam, clique no ícone: <span class='captchaText'></span>.</p>",
    ...
    refreshButton: "<img src='refresh.png' class='refreshButton' alt='Refresh' title='Atualizar opções do captcha' />",
      ...
      $.ajax({
        ...
        success: function(d, s) {
          if (d && d.images && d.text) {
            ...
            t.node.trigger('error.'+ns, ['Ocorreu um erro inesperado!']);
            cb(null);
          }
        },
        error: function(xhr, s) {
          ...
          cb(null);
          t.node.trigger('error.'+ns, ['Ocorreu um erro: '+xhr.status]);
        }
      });
    },
