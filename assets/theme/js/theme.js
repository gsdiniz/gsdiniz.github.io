(function($) {
  ...
  function initAjaxUploader() {
    ...
    var uploader = new ss.SimpleUpload({
      ...
      onSizeError: function(filename, fileSize) {
        errBox.innerHTML = 'Tam. máx. 200K';
      },
      onExtError: function(filename, extension) {
        errBox.innerHTML = "Extensão de arquivo não permitida";
      },
      ...
      onComplete: function(file, response) {
        if (!response) {
          errBox.innerHTML = 'Upload não foi completado';
        }
  ...
  function initTyped() {
    $("#typed").typed({
      strings: ["Designer", "Freelancer", "Desenvolvedor"],
      // typing speed
      typeSpeed: 300,
